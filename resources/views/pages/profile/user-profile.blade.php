...
<body class="relative">
    <div
        ...
        @php
            $linearGradient = "linear-gradient(to right, #f7e0d4, $profile->accent_color)";
            $background = $profile->is_gradient_view ? $linearGradient : $profile->accent_color;
        @endphp
        ...
        @php
            $linearGradient = "linear-gradient(to right, #f7e0d4, $profile->accent_color)";
            $accent = $profile->is_gradient_view ? $linearGradient : $profile->accent_color;
        @endphp
        ...
        <div class="max-w-full w-[800px] mx-auto grid grid-cols-2 gap-3">
            ...
            <div class="py-5 flex justify-center items-center relative flex-wrap break-words pr-4">
                <div
                    class="relative bg-gray-950 h-auto w-full rounded-lg bg-opacity-25 p-5 pt-10 flex flex-col transform transition-all duration-700">
                    <h1 class="text-xl text-gray-200 relative font-bold leading-6 flex gap-1">
                        Badges
                    </h1>
                    @if ($profile->badges)
